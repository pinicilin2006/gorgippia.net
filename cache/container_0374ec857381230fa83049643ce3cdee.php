...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'forum_config_text', $this->get('cache.driver'));
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'gorgippia', 'aq1sw2de3', 'gorgippia', '', false, false);
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'forum_log', $this->get('config'));
    }
    ...
    {
        return $this->services['uloginteam.ulogin.model'] = new \uloginteam\ulogin\core\model($this->get('config'), $this->get('dbal.conn'), $this->get('auth'), $this->get('user'), './', 'php', 'forum_');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'gorgippia',
            'dbal.dbpasswd' => 'aq1sw2de3',
            'dbal.dbname' => 'gorgippia',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
