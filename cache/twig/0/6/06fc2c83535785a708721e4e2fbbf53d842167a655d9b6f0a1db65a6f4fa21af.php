...
class __TwigTemplate_06fc2c83535785a708721e4e2fbbf53d842167a655d9b6f0a1db65a6f4fa21af extends Twig_Template
{
...
";
        ...
        if ((isset($context["S_DISPLAY_REVIEW"]) ? $context["S_DISPLAY_REVIEW"] : null)) {
            ...
            $this->loadTemplate("posting_topic_review.html", "posting_pm_layout.html", 37)->display($context);
            if ($namespace) {
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
        }
...
";
        ...
        if ((isset($context["S_DISPLAY_HISTORY"]) ? $context["S_DISPLAY_HISTORY"] : null)) {
            ...
            $this->loadTemplate("ucp_pm_history.html", "posting_pm_layout.html", 39)->display($context);
            if ($namespace) {
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
        }
...
";
        ...
        $this->loadTemplate("ucp_footer.html", "posting_pm_layout.html", 41)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
    ...
    {
        return array (  177 => 41,  174 => 40,  160 => 39,  157 => 38,  143 => 37,  137 => 33,  124 => 32,  121 => 31,  113 => 25,  111 => 24,  98 => 23,  97 => 22,  90 => 18,  87 => 17,  73 => 16,  70 => 15,  56 => 14,  53 => 13,  45 => 8,  41 => 7,  36 => 4,  34 => 3,  31 => 2,  19 => 1,);
    }
}
